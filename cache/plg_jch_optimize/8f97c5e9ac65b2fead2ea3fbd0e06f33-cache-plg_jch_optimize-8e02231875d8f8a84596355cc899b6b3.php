<?php die("Access Denied"); ?>#x#a:2:{s:6:"output";s:0:"";s:6:"result";s:21508:".err {
	background:#efefef url(/templates/e4jeasyhiring/html/com_vikrentcar/error.png) 10px no-repeat !important;
...
.warn {
	background:#efefef url(/templates/e4jeasyhiring/html/com_vikrentcar/warning.png) 10px no-repeat !important;
	border:1px solid #ddd !important;
	padding:22px 0 0 40px !important;
	color:#900;
	font-family:"Century Gothic", Tahoma, Arial;
...
.successmade {
	background:#efefef url(/templates/e4jeasyhiring/html/com_vikrentcar/success.png) 10px no-repeat !important;
	border:1px solid #ddd !important;
	padding:22px 0 0 40px !important;
	color:#006511;
	font-family:"Century Gothic", Tahoma, Arial;
...
.car_result {
	...
	width: 98%;
	padding: 8px;
	background:url(/templates/e4jeasyhiring/html/com_vikrentcar/sfboxcarlist.png) repeat-x;
}
...
/**********************************************************************************************/
    ...
    .vrcinfocarcontainer{width: 100%;}
    .vrcrentforlocs{width: 75%}
    .vrcrentalfor{  background-color: #452183;  color: rgba(229, 229, 229, 0.75);     margin: 0;
  padding: 2vw 0vw 2vw 2vw;}
    .vrcrentalfor .vrcrentalforone {  font-size: 2vw;}
    .vrcrentalfortwo{  padding: 2vw 0vw 2vw 2vw;   background-color: #e5e5e5;}";}