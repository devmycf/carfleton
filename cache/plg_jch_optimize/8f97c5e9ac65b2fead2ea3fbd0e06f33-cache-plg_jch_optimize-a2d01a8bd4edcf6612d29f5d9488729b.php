<?php die("Access Denied"); ?>#x#a:2:{s:6:"output";s:0:"";s:6:"result";s:21857:".err {
	background:#efefef url(/components/com_vikrentcar/error.png) 10px no-repeat !important;
...
.warn {
	background:#efefef url(/components/com_vikrentcar/warning.png) 10px no-repeat !important;
	border:1px solid #ddd !important;
	padding:22px 0 0 40px !important;
	color:#900;
	font-family:"Century Gothic", Tahoma, Arial;
...
.successmade {
	background:#efefef url(/components/com_vikrentcar/success.png) 10px no-repeat !important;
	border:1px solid #ddd !important;
	padding:22px 0 0 40px !important;
	color:#006511;
	font-family:"Century Gothic", Tahoma, Arial;
...
.booknow {
	height: 33px;
	background: transparent url(/components/com_vikrentcar/book.png) repeat-x;
...
.car_result {
	...
	width: 98%;
	padding: 8px;
	background:url(/components/com_vikrentcar/sfboxcarlist.png) repeat-x;
}
...
.vrclistgoon {
	background: url(/components/com_vikrentcar/book.png) repeat-x transparent;
    border-radius: 5px;
    cursor: pointer;
    font-size: 11px;
    padding: 7px 10px;
...
.vrclocationsmapdiv a {
	background: url(/components/com_vikrentcar/mapslocations-small.png) center top no-repeat;
	padding:105px 0 0;
	display:block;
}
...
.vrcsfentrycont .vrcsfentrydate .hasDatepicker {
	background:#fff url(/components/com_vikrentcar/resources/images/calendar-ext.png) 90% center no-repeat;
	border-radius: 2px;
...
.vrcsfentrycont #vrccomseldm {
	background: #fff url(/components/com_vikrentcar/resources/images/select-arrow-hour.png) right center no-repeat;
	overflow: hidden;
	display: inline-block;
	border: 1px solid #ccc;
   	border-radius: 4px;
...
.vrcdownloadpdf {
	font-weight: bold;
	background-image: url(/components/com_vikrentcar/resources/images/pdf_icon.gif);
