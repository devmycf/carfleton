...
if (vikrentcar :: allowRent()) {
	...
	$selform = "
    <div class=\"reserva-comun-cont test\">
    <section>
        <div class=\"wizard\">
            <div class=\"wizard-inner\">
                <div class=\"connecting-line\"></div>
                     <ul class=\"nav nav-tabs\">
                        <li class=\"active\">
                            <a href=\"\" title=\"\">
                                <img src=\"http://carflet.es/images/carflet/lugarblue.svg\" class=\"bubble-icon\">
                            </a>
...
<img src=\"http://carflet.es/images/carflet/desgloseblue.svg\" class=\"bubble-icon\">
    ...
    <div class=\"reserva-inner-cont\"><div class=\"reservamodulo\"><header><div class=\"imagen-reserva\"><div class=\"desc\"><div class=\"avatar-car-cont\"><img src=\"http://carflet.es/images/carflet/reservar2.svg\" class=\"avatar-car\"/></div><h1>Reserva en Carflet</h1><ul class=\"guide\">
            ...
            <div class=\"vrcdivsearchREMOVE\"><form action=\"".JRoute::_('index.php?option=com_vikrentcar')."\" method=\"get\">\n";
	...
	if (vikrentcar :: showPlacesFront()) {
		...
		if ($dbo->getNumRows() > 0) {
			...
			foreach ($places as $kpla=>$pla) {
				...
				//check if some place has closing days (1.7)
...
function vrcSetLocOpenTime(loc, where) {
	jQuery.ajax({
		...
		if(where == "pickup") {
			...
			jQuery("#vrccomselph").html(vrcobj.hours);
			jQuery("#vrccomselpm").html(vrcobj.minutes);
			jQuery("[name=pickuph]").html(vrcobj.hours);
			jQuery("[name=pickupm]").html(vrcobj.minutes);
		}else {
			console.log("entra4");
			jQuery("#vrccomseldh").html(vrcobj.hours);
			jQuery("#vrccomseldm").html(vrcobj.minutes);
			...
			$selform .= "<div class=\"bubble\" id=\"bubble-rec\"><h2>Recogida</h2><div class=\"bubble-col\"><div class=\"vrcsfentrycontREMOVE\">          <img src=\"http://carflet.es/images/carflet/lugar.svg\" class=\"bubble-icon\"/><label>" . JText :: _('VRPPLACE') . "</label><div class=\"vrcsfentryselectREMOVE\"><select name=\"place\" id=\"place\"".$onchangeplaces.">";
...
jQuery(function(){
	...
	jQuery('#releasedate').datepicker( 'option', jQuery.datepicker.regional[ 'vikrentcar' ] );
		...
		$selform .= "<div class=\"bubble-col\"><div class=\"vrcsfentrycont\"><div class=\"vrcsfentrylabsel\"><img src=\"http://carflet.es/images/carflet/calendar.svg\" class=\"bubble-icon\"/><label>" . JText :: _('VRPICKUPCAR') . "</label><div class=\"vrcsfentrydate\"><input type=\"text\" name=\"pickupdate\" id=\"pickupdate\" size=\"10\"/></div></div></div></div><div class=\"bubble-col\"><div class=\"vrcsfentrytime\"><label><img src=\"http://carflet.es/images/carflet/clock.svg\" class=\"bubble-icon\"/>" . JText :: _('VRALLE') . "</label><span id=\"vrccomselph\"><select name=\"pickuph\">" . $hours . "</select></span><span class=\"vrctimesep\">:</span><span id=\"vrccomselpm\"><select name=\"pickupm\">" . $minutes . "</select></span></div></div></div></div>\n";
		$selform .= "<div class=\"bubble\" id=\"bubble-dev\"><h2>Devolución</h2><div class=\"bubble-col\"><div class=\"vrcsfentrycont\"><div class=\"vrcsfentrylabsel\"><img src=\"http://carflet.es/images/carflet/calendar.svg\" class=\"bubble-icon\"/><label>" . JText :: _('VRRETURNCAR') . "</label><div class=\"vrcsfentrydate\"><input type=\"text\" name=\"releasedate\" id=\"releasedate\" size=\"10\"/></div></div></div></div><div class=\"bubble-col\"><div class=\"vrcsfentrytime\"><img src=\"http://carflet.es/images/carflet/clock.svg\" class=\"bubble-icon\"/><label>" . JText :: _('VRALLEDROP') . "</label><span id=\"vrccomseldh\"><select name=\"releaseh\">" . $hoursret . "</select></span><span class=\"vrctimesep\">:</span><span id=\"vrccomseldm\"><select name=\"releasem\">" . $minutesret . "</select></span></div></div>";
	}else {
	...
	//
	if (@ is_array($places)) {
		$selform .= "<div class=\"bubble-col\"><div class=\"vrcsfentrycont\"><img src=\"http://carflet.es/images/carflet/lugar.svg\" class=\"bubble-icon\"/><label>" . JText :: _('VRRETURNCARORD') . "</label><div class=\"vrcsfentryselectREMOVE\"><select name=\"returnplace\" id=\"returnplace\"".(strlen($onchangeplacesdrop) > 0 ? $onchangeplacesdrop : "").">";
		foreach ($places as $pla) {
		...
		$selform .= "</select></div></div></div></div>\n";
	}
	if (vikrentcar :: showCategoriesFront()) {
		...
		if ($dbo->getNumRows() > 0) {
			...
			$selform .= "<div class=\"bubble\" id=\"bubble-clase\"><h2>Clase</h2><div class=\"bubble-col\">                              <img src=\"http://carflet.es/images/carflet/coche.svg\" class=\"bubble-icon\"/><div class=\"vrcsfentrycont\"><label>" . JText :: _('VRCARCAT') . "</label></div></div><div class=\"bubble-col-2\"><div class=\"vrcsfentryselectREMOVE\"><select name=\"categories\">";
	...
	$selform .= "<div class=\"vrcsfentrycont\"><div class=\"vrcsfentrysubmit\"><input type=\"submit\" name=\"search\" value=\"" . vikrentcar :: getSubmitName() . "\"" . (strlen(vikrentcar :: getSubmitClass()) ? " class=\"" . vikrentcar :: getSubmitClass() . "\"" : "") . "/></div></div></div>\n";
	$selform .= "\n";
	...
	//
	$selform .= (!empty ($pitemid) ? "<input type=\"hidden\" name=\"Itemid\" value=\"" . $pitemid . "\"/>" : "") . "</form></div></div></div></div>";
