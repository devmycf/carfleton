...
class vikRentCarPayment {
	...
	public function showPayment () {
		...
		$form.="<input type=\"hidden\" name=\"item_number\" value=\"".$this->order_info['vehicle_name']."\"/>\n";
		...
		if($this->order_info['leave_deposit']) {
			$depositmess="<p><strong>".JText::_('VRLEAVEDEPOSIT')." ".vikrentcar::numberFormat($this->order_info['total_to_pay'])." ".$this->order_info['currency_symb']."</strong></p><br/>";
		}
		//output form
		echo $depositmess;
