...
// send button class
	...
	echo "\n<tr>";
		echo '<td class="prompt">'.JText::_('COM_FLEXICONTACT_CONFIG_BUTTON_CLASS').'</td>';
		echo '<td><input type="text" size="40" name="button_class" value="'.$this->config_data->button_class.'" /> '.
			Flexicontact_Utility::make_info(JText::_('COM_FLEXICONTACT_CONFIG_BUTTON_CLASS_DESC'),'http://getbootstrap.com/css/#buttons-options').'</td>';
	echo "\n</tr>";
